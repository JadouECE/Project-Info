...
///Constructeur Sommet
Sommet::Sommet(s_nom , s_type , s_index , s_population_t , s_population_tpost , s_regulation , s_nom_predateur)
{
    m_nom=s_nom;
    m_type=s_type;
    m_index=s_index;
    m_population_t=s_population_t;
...
Arc::Arc(a_nom_from , a_nom_to , a_coef)
{
    m_coef=a_coef;
