...
/**************************************************************
    ...
    C'est cette 2ème approche qui est proposée ici : dans la classe graphe vous trouverez
        -> map<int, Edge>   m_edges                                           aretes
        -> map<int, Vertex> m_vertices    (le pluriel de vertex est vertices) sommets
...
class Arc
{
    ...
    public:
        ...
        /// Ici on ne donne qu'un seul constructeur qui peut utiliser une interface
        Arc (std::string a_nom_from , std::string a_nom_to , float coef);
...
class Graph
{
    private :
        ...
        /// Nombre de sommets et la "liste" des sommets
        int m_nb_sommet;
        std::vector<Sommet> m_sommet;

        /// Le nombre d'aretes et liste des aretes
        int m_nb_arc;
    ...
    public:
        ...
        ///Sommet Graph::get_sommet(int i){return m_sommet[i]; }
