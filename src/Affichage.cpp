...
Affichage::Affichage()
{
    ...
    m_f_orque.set_frame(120, 30, 90, 90);
    m_f_orque.set_bg_color(BLEUCLAIR);
    m_f_orque.set_moveable();
    m_f_orque.add_child( m_orque );
    m_orque.set_pic_name("orque.bmp");

    m_fond.add_child( m_f_phoque );
    m_f_phoque.set_frame(250, 130, 90, 90);
    m_f_phoque.set_bg_color(BLEUCLAIR);
    ...
    m_pop_poisson.set_bg_color(NOIR);
